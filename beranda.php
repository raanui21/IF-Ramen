...
<!--Action boxes-->
  ...
  <div class="banner" style="text-align: center;">
    <div class="container">
      <img src="template/masuk/images/ramen3.png" alt="" class="img-fluid" style="height: 300px; width: 500px;"><br><br>
      <h1 class="font-weight-semibold">SELAMAT DATANG</h1>
      <h6 class="font-weight-normal text-muted pb-3">Di Sitem Pelayanan Restaurant Cepat Saji</h6>
      <div>
        <button class="btn btn-success mr-1"><a href="entri_order.php">Pesan Menu</a></button>
      </div>
    </div>
  </div>
